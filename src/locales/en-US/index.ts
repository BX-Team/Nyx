export default {
  ...
  settings: {
    ...
    actions: {
      ...
      resetWarning: '⚠️ All configurations will be deleted, including profiles, settings, and the core, ',
      cannotUndo: 'this action cannot be undone',
      confirmDelete: 'Confirm Delete',
      checkUpdate: 'Check for Updates',
      noNeedUpdate: 'No update needed',
      resetApp: 'Reset App',
      resetAppHelp: 'Completely resets the application configuration, including profiles, settings, and the core',
