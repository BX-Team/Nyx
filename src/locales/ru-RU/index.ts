export default {
  ...
  settings: {
    ...
    actions: {
      ...
      resetWarning: '⚠️ Будут удалены все конфигурации, включая профили, настройки и ядро, ',
      cannotUndo: 'это действие нельзя отменить',
      confirmDelete: 'Подтвердить удаление',
      checkUpdate: 'Проверить обновления',
      noNeedUpdate: 'Обновление не требуется',
      resetApp: 'Сбросить приложение',
      resetAppHelp: 'Полностью сбрасывает конфигурацию приложения, включая профили, настройки и ядро',
