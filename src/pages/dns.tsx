...
import AdvancedDnsSetting from '@/components/dns/advanced-dns-setting';
...
import { isValidDnsServer, isValidDomainWildcard, isValidIPv4Cidr, isValidIPv6Cidr } from '@/utils/validate';
      ...
      <SettingCard>
            ...
            <SettingItem title={t('pages.dns.fakeIPRangeIPv4')} divider>
              <Tooltip open={!!fakeIPRangeError}>
                <TooltipTrigger asChild>
                  <Input
                    className={`h-8 w-[40%] ${fakeIPRangeError ? 'border-red-500 ring-1 ring-red-500 rounded-lg' : ''}`}
                ...
                <TooltipContent side='right' sideOffset={15} className='bg-destructive text-destructive-foreground'>
            ...
            {values.ipv6 && (
              <SettingItem title={t('pages.dns.fakeIPRangeIPv6')} divider>
                <Tooltip open={!!fakeIPRange6Error}>
                  <TooltipTrigger asChild>
                    <Input
                      className={`h-8 w-[40%] ${fakeIPRange6Error ? 'border-red-500 ring-1 ring-red-500 rounded-lg' : ''}`}
                  ...
                  <TooltipContent side='right' sideOffset={10} className='bg-destructive text-destructive-foreground'>
        ...
        <EditableList
          ...
          onChange={list => {
            ...
            setNameserverError(firstInvalid ? (isValidDnsServer(firstInvalid).error ?? t('common.formatError')) : null);
          }}
