...
function initWindowFocusTracking(): void {
  ...
  window.addEventListener(
    ...
    (e: PointerEvent) => {
      ...
      } else if (e.clientX !== windowFocusSuppress.anchorX || e.clientY !== windowFocusSuppress.anchorY) {
...
function Tooltip({
  ...
  return <TooltipPrimitive.Root data-slot='tooltip' open={open} onOpenChange={onOpenChange} {...props} />;
}
