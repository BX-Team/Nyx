...
import InterfaceModal from '@/components/mihomo/interface-modal';
...
import { restartCore, triggerSysProxy } from '@/utils/ipc';
      ...
      <SettingCard title={t('mihomo.portSettings.title')}>
        <SettingItem title={t('mihomo.portSettings.mixedPort')} divider>
          <div className='flex'>
            ...
            <Input
              ...
              min={0}
              onChange={e => {
                setMixedPortInput(parseInt(e.target.value, 10) || 0);
              }}
            />
          </div>
        </SettingItem>
        <SettingItem title={t('mihomo.portSettings.socksPort')} divider>
          <div className='flex'>
            ...
            <Input
              ...
              min={0}
              onChange={e => {
                setSocksPortInput(parseInt(e.target.value, 10) || 0);
              }}
            />
          </div>
        </SettingItem>
        <SettingItem title={t('mihomo.portSettings.httpPort')} divider>
          <div className='flex'>
            ...
            <Input
              ...
              min={0}
              onChange={e => {
                setHttpPortInput(parseInt(e.target.value, 10) || 0);
              }}
            />
          </div>
        </SettingItem>
          ...
          <SettingItem title={t('mihomo.portSettings.redirPort')} divider>
            <div className='flex'>
              ...
              <Input
                ...
                min={0}
                onChange={e => {
                  setRedirPortInput(parseInt(e.target.value, 10) || 0);
                }}
              />
            </div>
          </SettingItem>
          ...
          <SettingItem title={t('mihomo.portSettings.tproxyPort')} divider>
            <div className='flex'>
              ...
              <Input
                ...
                min={0}
                onChange={e => {
                  setTproxyPortInput(parseInt(e.target.value, 10) || 0);
                }}
              />
            </div>
          </SettingItem>
        ...
        <SettingItem title={t('mihomo.portSettings.authentication')}>
          {authenticationInput.join() !== authentication.join() && (
            <Button size='sm' onClick={() => onChangeNeedRestart({ authentication: authenticationInput })}>
              {t('common.confirm')}
            </Button>
          )}
        </SettingItem>
